"""Provide filters for querying cads and limit the generated results.
...
class DistanceFilter(AttributeFilter):
    """Subclass of superclass AttributeFilter."""

    @classmethod
    def get(cls, approach):
        """Override the method of the superclass.

        :return: distance filter of a CloseApproach
        """
...
class VelocityFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :return: velocity filter of a CloseApproach
        """
...
class DiameterFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :return: diameter filter of a NEO
        """
...
class HazardousFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :return: hazardous filter of a NEO
        """
...
class DateFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :return: date filter of a CloseApproach
        """
...
def create_filters(date=None, start_date=None, end_date=None,
    ...
    if distance_min:
        collection_filter.append(DistanceFilter(operator.ge, distance_min))
    if distance_max:
        collection_filter.append(DistanceFilter(operator.le, distance_max))
    if velocity_min:
        collection_filter.append(VelocityFilter(operator.ge, velocity_min))
    if velocity_max:
        collection_filter.append(VelocityFilter(operator.le, velocity_max))
    if diameter_min:
        collection_filter.append(DiameterFilter(operator.ge, diameter_min))
    if diameter_max:
        collection_filter.append(DiameterFilter(operator.le, diameter_max))
    if hazardous is not None:
        collection_filter.append(HazardousFilter(operator.eq, hazardous))
    if date:
        collection_filter.append(DateFilter(operator.eq, date))
    if start_date:
        collection_filter.append(DateFilter(operator.ge, start_date))
    if end_date:
        collection_filter.append(DateFilter(operator.le, end_date))
